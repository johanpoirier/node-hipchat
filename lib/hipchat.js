  ...
  HipChatClient = (function() {
    ...
    HipChatClient.prototype.createRoom = function(params, callback) {
      ...
      data = {
        ...
        topic: params.topic,
        guest_access: params.guest_access ? true : false
      };
    ...
    HipChatClient.prototype.createRoomWebhook = function(room, params, callback) {
      var options, data;
      data = {
        name: params.name,
        url: params.url,
      ...
      options = this._prepareOptions({
        method: 'post',
        path: '/v2/room/' + room + '/extension/webhook/' + params.key,
        query: data
      });
      return this._sendRequest(options, callback);
    };

    HipChatClient.prototype.deleteRoomWebhook = function(room, key, callback) {
      var options;
      options = this._prepareOptions({
        method: 'delete',
        path: '/v2/room/' + room + '/extension/webhook/' + key
      });
      return this._sendRequest(options, callback);
    };
    ...
    HipChatClient.prototype._prepareOptions = function(op) {
      ...
      if (op.method === 'post' && (op.data != null)) {
        ...
        op.headers['Content-Length'] = Buffer.byteLength(op.data);
      }
      if (this.agent) {
        op.agent = this.agent;
      }
